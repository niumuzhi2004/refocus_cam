...
HD_PWD='C:/Users/niumu/Refocusing/camera_screen/camera_screen.runs/cam_to_mem_v_vid_in_axi4s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cam_to_mem_v_vid_in_axi4s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cam_to_mem_v_vid_in_axi4s_0_0.tcl
