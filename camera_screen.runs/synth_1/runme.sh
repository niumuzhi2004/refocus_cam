...
HD_PWD='C:/Users/niumu/Refocusing/camera_screen/camera_screen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cam_to_mem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cam_to_mem_wrapper.tcl
