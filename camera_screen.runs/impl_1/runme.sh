...
HD_PWD='C:/Users/niumu/Refocusing/camera_screen/camera_screen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cam_to_mem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cam_to_mem_wrapper.tcl -notrace
