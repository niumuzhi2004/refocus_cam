...
--               c:/Users/niumu/Refocusing/camera_screen/camera_screen.gen/sources_1/bd/cam_to_mem/ip/cam_to_mem_util_ds_buf_1_0/cam_to_mem_util_ds_buf_1_0_sim_netlist.vhdl
...
entity cam_to_mem_util_ds_buf_1_0_util_ds_buf is
  port (
    ...
    MBUFGCE_CE : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_CLRB_LEAF : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_O1 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_O2 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_O3 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_O4 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_CE : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_CLRB_LEAF : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_CLR : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_O1 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_O2 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_O3 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCE_DIV_O4 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_CE0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_CE1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_CLRB_LEAF : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_IGNORE0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_IGNORE1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_I0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_I1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_S0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_S1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_O1 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_O2 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_O3 : out STD_LOGIC_VECTOR ( 0 to 0 );
    MBUFGCTRL_O4 : out STD_LOGIC_VECTOR ( 0 to 0 );
    IBUFDS_GTM2_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUFDS_GTM2_IB : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUFDS_GTM2_O : out STD_LOGIC_VECTOR ( 0 to 0 );
    IBUFDS_GTM2_ODIV2 : out STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_CE0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_CE1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_I0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_I1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_IGNORE0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_IGNORE1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_S0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_S1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFGCTRL_O : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute C_BUFGCE_DIV : integer;
  attribute C_BUFGCE_DIV of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is "IOBUF";
  attribute C_DIVBY2 : integer;
  attribute C_DIVBY2 of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is 0;
  attribute C_MODE : string;
  attribute C_MODE of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cam_to_mem_util_ds_buf_1_0_util_ds_buf : entity is "util_ds_buf";
end cam_to_mem_util_ds_buf_1_0_util_ds_buf;

architecture STRUCTURE of cam_to_mem_util_ds_buf_1_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cam_to_mem_util_ds_buf_1_0 is
  port (
    IOBUF_IO_T : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_O : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of cam_to_mem_util_ds_buf_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cam_to_mem_util_ds_buf_1_0 : entity is "cam_to_mem_util_ds_buf_1_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of cam_to_mem_util_ds_buf_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of cam_to_mem_util_ds_buf_1_0 : entity is "util_ds_buf,Vivado 2025.2";
end cam_to_mem_util_ds_buf_1_0;

architecture STRUCTURE of cam_to_mem_util_ds_buf_1_0 is
  signal NLW_U0_BUFGCE_O_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_BUFGCTRL_O_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal NLW_U0_IBUFDS_GTM2_O_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_IBUFDS_GTM2_ODIV2_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal NLW_U0_MBUFGCE_DIV_O1_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCE_DIV_O2_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCE_DIV_O3_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCE_DIV_O4_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCE_O1_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCE_O2_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCE_O3_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCE_O4_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCTRL_O1_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCTRL_O2_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCTRL_O3_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal NLW_U0_MBUFGCTRL_O4_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
...
begin
U0: entity work.cam_to_mem_util_ds_buf_1_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
      ...
      BUFGCTRL_I0(0) => '1',
      BUFGCTRL_I1(0) => '1',
      BUFGCTRL_IGNORE0(0) => '1',
      BUFGCTRL_IGNORE1(0) => '1',
      BUFGCTRL_O(0) => NLW_U0_BUFGCTRL_O_UNCONNECTED(0),
      BUFGCTRL_S0(0) => '1',
      BUFGCTRL_S1(0) => '1',
      BUFG_FABRIC_I(0) => '0',
      ...
      IBUFDS_GTM2_I(0) => '0',
      IBUFDS_GTM2_IB(0) => '0',
      IBUFDS_GTM2_O(0) => NLW_U0_IBUFDS_GTM2_O_UNCONNECTED(0),
      IBUFDS_GTM2_ODIV2(0) => NLW_U0_IBUFDS_GTM2_ODIV2_UNCONNECTED(0),
      ...
      MBUFGCE_CE(0) => '1',
      MBUFGCE_CLRB_LEAF(0) => '1',
      MBUFGCE_DIV_CE(0) => '1',
      MBUFGCE_DIV_CLR(0) => '1',
      MBUFGCE_DIV_CLRB_LEAF(0) => '1',
      MBUFGCE_DIV_I(0) => '1',
      MBUFGCE_DIV_O1(0) => NLW_U0_MBUFGCE_DIV_O1_UNCONNECTED(0),
      MBUFGCE_DIV_O2(0) => NLW_U0_MBUFGCE_DIV_O2_UNCONNECTED(0),
      MBUFGCE_DIV_O3(0) => NLW_U0_MBUFGCE_DIV_O3_UNCONNECTED(0),
      MBUFGCE_DIV_O4(0) => NLW_U0_MBUFGCE_DIV_O4_UNCONNECTED(0),
      MBUFGCE_I(0) => '1',
      MBUFGCE_O1(0) => NLW_U0_MBUFGCE_O1_UNCONNECTED(0),
      MBUFGCE_O2(0) => NLW_U0_MBUFGCE_O2_UNCONNECTED(0),
      MBUFGCE_O3(0) => NLW_U0_MBUFGCE_O3_UNCONNECTED(0),
      MBUFGCE_O4(0) => NLW_U0_MBUFGCE_O4_UNCONNECTED(0),
      MBUFGCTRL_CE0(0) => '1',
      MBUFGCTRL_CE1(0) => '1',
      MBUFGCTRL_CLRB_LEAF(0) => '1',
      MBUFGCTRL_I0(0) => '1',
      MBUFGCTRL_I1(0) => '1',
      MBUFGCTRL_IGNORE0(0) => '1',
      MBUFGCTRL_IGNORE1(0) => '1',
      MBUFGCTRL_O1(0) => NLW_U0_MBUFGCTRL_O1_UNCONNECTED(0),
      MBUFGCTRL_O2(0) => NLW_U0_MBUFGCTRL_O2_UNCONNECTED(0),
      MBUFGCTRL_O3(0) => NLW_U0_MBUFGCTRL_O3_UNCONNECTED(0),
      MBUFGCTRL_O4(0) => NLW_U0_MBUFGCTRL_O4_UNCONNECTED(0),
      MBUFGCTRL_S0(0) => '1',
      MBUFGCTRL_S1(0) => '1',
      MBUFG_GT_CE(0) => '1',
      MBUFG_GT_CEMASK(0) => '0',
