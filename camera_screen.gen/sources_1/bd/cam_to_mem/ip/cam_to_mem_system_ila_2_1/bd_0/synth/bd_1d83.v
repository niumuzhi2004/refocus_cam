...
//--------------------------------------------------------------------------------
//Command: generate_target bd_1d83.bd
//Design : bd_1d83
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_1d83,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_1d83,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "cam_to_mem_system_ila_2_1.hwdef" *) 
module bd_1d83
   (SLOT_0_AXIS_tdata,
    SLOT_0_AXIS_tkeep,
    SLOT_0_AXIS_tlast,
    ...
    probe7,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_0_AXIS TDATA" *) (* X_INTERFACE_MODE = "Monitor SlaveType" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXIS, CLK_DOMAIN cam_to_mem_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 150000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1" *) input [15:0]SLOT_0_AXIS_tdata;
  ...
  input [0:0]probe6;
  input [0:0]probe7;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.RESETN RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.RESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW, PortWidth 1" *) input resetn;
  ...
  bd_1d83_ila_lib_0 ila_lib
       (.clk(clk),
        .probe0(probe0),
        .probe1(probe1),
        .probe10(net_slot_0_axis_tuser),
        .probe11(net_slot_0_axis_tvalid),
        .probe12(net_slot_0_axis_tready),
        .probe13(net_slot_0_axis_tlast),
        .probe14(net_slot_1_axis_tdata),
        .probe15(net_slot_1_axis_tkeep),
        .probe16(net_slot_1_axis_tuser),
        .probe17(net_slot_1_axis_tvalid),
        .probe18(net_slot_1_axis_tready),
        .probe19(net_slot_1_axis_tlast),
        .probe2(probe2),
        .probe20(net_slot_2_axis_tdata),
        .probe21(net_slot_2_axis_tuser),
        .probe22(net_slot_2_axis_tvalid),
        .probe23(net_slot_2_axis_tready),
        .probe24(net_slot_2_axis_tlast),
        .probe3(probe3),
        .probe4(probe4),
        .probe5(probe5),
        .probe6(probe6),
