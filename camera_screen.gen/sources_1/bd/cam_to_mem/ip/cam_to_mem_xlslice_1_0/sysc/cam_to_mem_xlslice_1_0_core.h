...
#ifndef _cam_to_mem_xlslice_1_0_core_h_
#define _cam_to_mem_xlslice_1_0_core_h_

#include <systemc.h>
#include "properties.h"


class cam_to_mem_xlslice_1_0_core : public sc_module 
{
    public: 
       cam_to_mem_xlslice_1_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(cam_to_mem_xlslice_1_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~cam_to_mem_xlslice_1_0_core() = default;
