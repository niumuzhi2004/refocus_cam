...
(* CHECK_LICENSE_TYPE = "cam_to_mem_v_proc_ss_0_1,bd_f78e,{}" *) (* CORE_GENERATION_INFO = "cam_to_mem_v_proc_ss_0_1,bd_f78e,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=v_proc_ss,x_ipVersion=2.3,x_ipCoreRevision=17,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,Component_Name=cam_to_mem_v_proc_ss_0_1,C_SCALER_ALGORITHM=1,C_TOPOLOGY=1,C_SAMPLES_PER_CLK=1,C_MAX_DATA_WIDTH=8,C_NUM_VIDEO_COMPONENTS=3,C_MAX_COLS=2592,C_MAX_ROWS=1944,C_H_SCALER_TAPS=6,C_V_SCALER_TAPS=6,C_H_SCALER_PHASES=64,C_V_SCALER_PHASES=64,C_CHROMA_ALGORITHM=2,C_H_CHROMA_ALGORITHM=2,C_V_CHROMA_ALGORITHM=2,C_H_CHROMA_TAPS=4,C_V_CHROMA_TAPS=4,C_ENABLE_INTERLACED=false,C_ENABLE_DMA=false,C_SCALER_ENABLE_422=true,C_ENABLE_CSC=false,C_CSC_ENABLE_422=true,C_CSC_ENABLE_WINDOW=false,C_DEINT_MOTION_ADAPTIVE=true,C_COLORSPACE_SUPPORT=2,C_USE_URAM=0,C_READ_FIFO_DEPTH=128,C_WRITE_FIFO_DEPTH=128,C_AXIMM_DATA_WIDTH=64,C_AXIMM_ADDR_WIDTH=32,C_VDMA_AXIMM_ADDR_WIDTH=32,C_AXIMM_NUM_OUTSTANDING=16,C_AXIMM_BURST_LENGTH=16}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(aclk_axis, aclk_ctrl, aresetn_ctrl, 
  ...
  s_axis_tuser, s_axis_tvalid, m_axis_tvalid, m_axis_tready, m_axis_tdata, m_axis_tdest, 
