...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bd_f78e_input_size_set_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_f78e_input_size_set_0,top_bd_f78e_input_size_set_0,{}" *) (* CORE_GENERATION_INFO = "bd_f78e_input_size_set_0,top_bd_f78e_input_size_set_0,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axis_subset_converter,x_ipVersion=1.1,x_ipCoreRevision=36,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_S_AXIS_TDATA_WIDTH=24,C_S_AXIS_TID_WIDTH=1,C_S_AXIS_TDEST_WIDTH=1,C_S_AXIS_TUSER_WIDTH=1,C_S_AXIS_SIGNAL_SET=0b00000000000000000000000011111111,C_M_AXIS_TDATA_WIDTH=24,C_M_AXIS_TID_WIDTH=1,C_M_AXIS_TDEST_WIDTH=1,C_M_AXIS_SIGNAL_SET=0b00000000000000000000000011111111,C_M_AXIS_TUSER_WIDTH=1,C_DEFAULT_TLAST=0}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
