...
// Command     : write_verilog -force -mode synth_stub -rename_top cam_to_mem_proc_sys_reset_1_0 -prefix
//               cam_to_mem_proc_sys_reset_1_0_ cam_to_mem_proc_sys_reset_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "cam_to_mem_proc_sys_reset_1_0,proc_sys_reset,{}" *) (* core_generation_info = "cam_to_mem_proc_sys_reset_1_0,proc_sys_reset,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=proc_sys_reset,x_ipVersion=5.0,x_ipCoreRevision=17,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_EXT_RST_WIDTH=4,C_AUX_RST_WIDTH=4,C_EXT_RESET_HIGH=0,C_AUX_RESET_HIGH=0,C_NUM_BUS_RST=1,C_NUM_PERP_RST=1,C_NUM_INTERCONNECT_ARESETN=1,C_NUM_PERP_ARESETN=1}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "proc_sys_reset,Vivado 2025.2" *) 
module cam_to_mem_proc_sys_reset_1_0(slowest_sync_clk, ext_reset_in, aux_reset_in, 
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 33333336, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN cam_to_mem_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
