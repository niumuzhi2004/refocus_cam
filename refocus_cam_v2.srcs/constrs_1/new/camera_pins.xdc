...
# Camera Reset & PWDN
set_property PACKAGE_PIN Y9 [get_ports {EMIO_O[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_O[0]}]

set_property PACKAGE_PIN Y8 [get_ports {EMIO_O[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_O[1]}]

set_property PACKAGE_PIN V5 [get_ports {EMIO_O[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_O[2]}]
...
set_property PACKAGE_PIN T19 [get_ports {EMIO_O[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_O[3]}]
...
# Blue Channel - 5 bits
set_property PACKAGE_PIN R17 [get_ports {lcd_blue[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {lcd_blue[4]}]

set_property PACKAGE_PIN R16 [get_ports {lcd_blue[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {lcd_blue[3]}]

set_property PACKAGE_PIN U19 [get_ports {lcd_blue[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {lcd_blue[2]}]

set_property PACKAGE_PIN U18 [get_ports {lcd_blue[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {lcd_blue[1]}]

set_property PACKAGE_PIN W19 [get_ports {lcd_blue[0]}]
...
####### PL BUTTONS #######
set_property PACKAGE_PIN G20 [get_ports {EMIO_I[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_I[0]}]

set_property PACKAGE_PIN H15 [get_ports {EMIO_I[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_I[1]}]

set_property PACKAGE_PIN G15 [get_ports {EMIO_I[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {EMIO_I[2]}]
