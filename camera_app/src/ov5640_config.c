...
//  ov5640_write_reg(0x3036, 0x2C); // 35M
	...
	ov5640_write_reg(0x3800, 0x00); // X start high bit
	ov5640_write_reg(0x3801, 0x00); // X start low bit
	ov5640_write_reg(0x3802, 0x00); // Y start high bit
	ov5640_write_reg(0x3803, 0xf4); // Y start low bit
	ov5640_write_reg(0x3804, 0x0a); // X end high bit
	ov5640_write_reg(0x3805, 0x1f); // X end low bit
	ov5640_write_reg(0x3806, 0x06); // Y end high bit
	ov5640_write_reg(0x3807, 0xa5); // Y end low bit
	...
	ov5640_write_reg(0x3808, 0x07);  //DVP 输出水平像素点数高4位
	ov5640_write_reg(0x3809, 0x80);  //DVP 输出水平像素点数低8位
	ov5640_write_reg(0x380a, 0x04);  //DVP 输出垂直像素点数高3位
	ov5640_write_reg(0x380b, 0x38);  //DVP 输出垂直像素点数低8位
